...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		//['Overlay Lights', "Value 1: 0 = Turn off, 1 = Blue, 2 = Green,\n3 = Pink, 4 = Red, 5 = Orange, Anything else = Random."],
		//['Kill Henchmen', "For Mom's songs, don't use this please, i love them :("],
		['', "Nothing. Yep, that's right."],
		['Camera Beat', "Used on MILF on that one \"hard\" part\nValue 1: Camera zoom add (Default: 0.015)\nValue 2: UI zoom add (Default: 0.03)\nLeave the values blank if you want to use Default."],
		...
		['Play Overlay Animation', "Value 1: Name of the PNG\nValue 2: Name of the animation"],
	...
	**/
	...
	override function create()
	{
		...
		for (i in 0...tipTextArray.length) {
			var tipText:FlxText = new FlxText(UI_box.x, UI_box.y + UI_box.height + 6, 0, tipTextArray[i], 16);
			tipText.y += i * 14;
	...
	function addNoteUI():Void
	{
		...
		var stepperMania:FlxUINumericStepper = new FlxUINumericStepper(10, 105, 1, 0, 0, 3, 1);
		stepperMania.value = _song.mania;
		stepperMania.name = 'mania';

		noteTypeDropDown = new FlxUIDropDownMenuCustom(10, 145, FlxUIDropDownMenuCustom.makeStrIdLabelArray(displayNameList, true), function(character:String)
		{
		...
		tab_group_note.add(new FlxText(10, 90, 0, 'Mania:'));
		tab_group_note.add(new FlxText(10, 130, 0, 'Note type:'));
	...
	function reloadGridLayer() {
		gridLayer.clear();
		gridBG = FlxGridOverlay.create(GRID_SIZE, GRID_SIZE, GRID_SIZE + GRID_SIZE * Main.ammo[_song.mania] * 2, Std.int(GRID_SIZE * 32 * zoomList[curZoom]));
